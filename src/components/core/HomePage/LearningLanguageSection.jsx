    ...
    <div className='mt-[130px]'>
        <div className='flex flex-col gap-5 items-center'>
            ...
            <div className='flex flex-row items-center justify-center'>
                <img src={know_your_progress} alt="know_your_progess image" className='object-contain -mr-28'/>
                <img src={compare_with_others} alt="compare_with_others image" className='object-contain'/>
                <img src={plan_your_lesson} alt="plan_your_lesson image" className='object-contain -ml-36'/>
            </div>
